...
@WebServlet("/addFriendMatch")
public class addFriendMatch extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
		...
		try
		{
			...
			PreparedStatement st = con.prepareStatement("update Matches set status=\"accepted\" where matchId=?");
			st.setInt(1,mid);
			st.executeUpdate();
			st.close(); 
			con.close();
